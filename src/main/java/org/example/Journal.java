...
public class Journal {
    ...
    private Calendar add(int dayOfMonth, int term) {
      return null;
    }
    ...
    public void setDateOfIssue(Calendar dateOfIssue){this.dateOfIssue=dateOfIssue;}
    public Calendar getDateReturn(){return dateReturn;}
